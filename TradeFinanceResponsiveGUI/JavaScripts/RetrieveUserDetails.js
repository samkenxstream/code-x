...
var RetrieveUserDetails_Module = (function () {
            ...
            if (this.status == 200) {
                ...
                if (this.readyState == 4) {
                    ...
                    if (bChangeDisplayAsPerUser == true && FlowControlGlobalsModule.bFirstTimeAuthentication == true) {
                        ...
                        redirectFirstTimeUserPageBasedOnUserType(singleUserObject);
                    }
    ...
    **********************************************************************************************************/
    ...
    function redirectFirstTimeUserPageBasedOnUserType(singleUserObject) {

        var currentUserType = singleUserObject.UserType;

        if (currentUserType == "Buyer") {

            document.location.replace("./TradeBuyer.html");

        } else if (currentUserType == "Seller") {

            document.location.replace("./TFSeller.html");
            ...
            alert("redirectFirstTimeUserPageBasedOnUserType : Unknown UserType, Can't Login : currentUserType : " + currentUserType);
